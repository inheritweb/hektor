...
export interface AdminOrganisationDetailViewModel extends OrganisationDetailsRailViewModel {
    ...
    <div>
      <div className="grid items-start gap-10 lg:grid-cols-[minmax(14rem,0.7fr)_minmax(0,2fr)] lg:gap-14">
        ...
        <div className="space-y-10">
          <CollectionSection
            description="Account linking and roles within this organisation."
            icon={LuUsers}
            separated={false}
            title="Users"
          >
            <div className="grid gap-px bg-border sm:grid-cols-2 xl:grid-cols-4">
              {[
                ...
                ['Linked accounts', users.linked],
                ['Awaiting account linking', users.awaitingAccountLinking],
