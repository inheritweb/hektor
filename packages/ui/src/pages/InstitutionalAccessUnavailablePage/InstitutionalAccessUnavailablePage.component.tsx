...
export function InstitutionalAccessUnavailablePage({
  ...
  return (
    <UnauthenticatedTemplate>
      <p className="text-sm font-semibold text-primary">Institutional access</p>
      ...
      <p className="mt-4 leading-7 text-muted-foreground">
        Please contact your institutional administrator and ask them to add you
        to Hektor. No Hektor account has been created.
      </p>
    </UnauthenticatedTemplate>
  );
}
